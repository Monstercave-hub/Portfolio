...
!function (n, t) {
  ...
  var e = [],
      r = function (t, o, i) {
          n.timer(function () {
              ...
              for (var n = 0; n < i.onDraw.length; n++) 
                  i.onDraw[n]()
      ...
      l = function (n, t) {
          ...
          for (0 === t.length && (c.plugins.earth && n.loadPlugin(c.plugins.earth()), c.plugins.pings && n.loadPlugin(c.plugins.pings())), o = 0; o < t.length; o++) 
              t[o](n)
          ...
          planet: function () {
              var t = [],
                  ...
                  i = {
                      ...
                      stop: function () {
                          i.stopped = !0;
                          for (var n = 0; n < o.onStop.length; n++) 
                              o.onStop[n](i)
          ...
          o.onInit(function (i) {
              if (t.world) 
                  ...
                  n.json(e, function (n, t) {
                      if (n) 
                          throw new Error("Could not load JSON " + e);
      ...
      return function (o) {
          ...
          o.onDraw(function () {
              o.withSavedContext(function (t) {
                  ...
                  n.stroke && (n.lineWidth && (t.lineWidth = n.lineWidth), t.strokeStyle = n.stroke, t.stroke())
              })
          })
      }
  },
  ...
  c.plugins.pings = function (t) {
      ...
      var i = function (n, i, e) {
              e = e || {},
              e.color = e.color || t.color || "white",
              e.angle = e.angle || t.angle || 5,
              e.ttl = e.ttl || t.ttl || 2e3;
              var r = {
                  time: new Date,
                  options: e
              };
          ...
          r = function (t, o, i, e, r) {
              ...
              var u = n
                  ...
                  .circle()
                  .origin([r.lng, r.lat])
                  .angle(e / r.options.ttl * r.options.angle)();
              o.beginPath(),
              t.path.context(o)(u),
              o.stroke()
          };
  ...
  c.plugins.zoom = function (t) {
      ...
      return function (t) {
          t.onInit(function () {
              ...
              o
                  .on("zoomstart", i.bind(t))
                  .on("zoomend", e.bind(t))
                  .on("zoom", function () {
                      r.call(t),
                      t.projection.scale(n.event.scale),
                      l.call(t)
                  }),
