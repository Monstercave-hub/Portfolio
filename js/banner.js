    ...
    J.prototype = {
        ...
        recognize: function (t) {
            ...
            return h(this.options.enable, [this, e])
                ? (this.state & (Te | ye | Ce) && (this.state = fe), this.state = this.process(e), void(this.state & (ve | me | ge | ye) && this.tryEmit(e)))
    ...
    l(it, et, {
        ...
        attrTest: function (t) {
            return et
                .prototype
                .attrTest
                .call(this, t) && (this.state & ve || !(this.state & ve) && this.directionTest(t))
        },
        emit: function (t) {
            this.pX = t.deltaX,
            this.pY = t.deltaY;
    ...
    l(nt, et, {
        ...
        attrTest: function (t) {
            return this
                ._super
                .attrTest
                .call(this, t) && (Math.abs(t.scale - 1) > this.options.threshold || this.state & ve)
        },
        emit: function (t) {
            if (1 !== t.scale) {
                var e = t.scale < 1
    ...
    l(rt, et, {
        ...
        attrTest: function (t) {
            return this
                ._super
                .attrTest
                .call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & ve)
        }
    }),
    l(ot, et, {
        defaults: {
        ...
        attrTest: function (t) {
            ...
            this
                ._super
                .attrTest
                .call(this, t) && e & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && mt(i) > this.options.velocity && t.eventType & Rt
        },
        emit: function (t) {
                ...
                t.hasClass("slider--next")
                    ? a - 1 > i && a - 1 > s && a - 1 > o
                        ? (l
                            ...
                            .next()
                            .addClass("slider--item-left"), c
                            .removeClass("slider--item-center")
                            .next()
                            .addClass("slider--item-center"), h
